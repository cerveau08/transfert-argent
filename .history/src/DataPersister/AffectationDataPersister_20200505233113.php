              ...
              //  {
                        ...
                        $data->getUserComptePartenaire()->getRoles()[0] == "ROLE_ADMIN" )
                    {
                        ...
                        for ($i=0; $i <count($affectCompte) ; $i++) { 
                            ...
                            if ($userAffect == $data->getUserComptePartenaire() &&( ($dateDebut <= $data->getDateDebut() && $dateFin >= $data->getDateDebut()) ||  ($dateDebut <= $data->getDateFin() && $dateFin >= $data->getDateFin()) || ($dateDebut <= $data->getDateFin() && $dateFin >= $data->getDateFin())))
                            {
