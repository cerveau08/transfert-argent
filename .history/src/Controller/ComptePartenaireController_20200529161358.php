...
class ComptePartenaireController extends AbstractController
{
    ...
    public function getAllTransaction()
    {
      ...
      //  dd($userconnect);
        ...
        elseif($rolesUser === 'ROLE_PARTENAIRE' || $rolesUser === 'ROLE_ADMIN_PARTENAIRE')
        {
            ...
            foreach($transactions as $transaction)
            {
                if($nineauser === $transaction->getCompteEmetteur()->getPartenaire()->getNinea() || $nineauser === $transaction->getCompteEmetteur()->getPartenaire()->getNinea())
                {
                    $data[$i]=$transaction;
                    $i++;
                }
    ...
    /**
     * @Route("/affectation", name="compte", methods={"GET"})
     */
